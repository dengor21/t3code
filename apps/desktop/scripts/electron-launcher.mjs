// This file mostly exists because we want dev mode to say "HAL (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = formatDisplayName(APP_BASE_NAME, isDevelopment ? "Dev" : "Alpha");
