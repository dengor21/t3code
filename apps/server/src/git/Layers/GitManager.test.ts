...
function createTextGeneration(overrides: Partial<FakeGitTextGeneration> = {}): TextGenerationShape {
  const implementation: FakeGitTextGeneration = {
    ...
    generateChangeDocumentation: () =>
      Effect.succeed({
        ...
        summary: "Updated workflow documentation.",
  ...
  return {
    ...
    generateChangeDocumentation: (input) =>
      implementation.generateChangeDocumentation(input).pipe(
        Effect.mapError(
          (cause) =>
            new TextGenerationError({
              ...
              JSON.stringify([
                {
                  ...
                  url: "https://github.com/dengor21/t3code/pull/1661",
                  baseRefName: "main",
                  headRefName: "main",
                  state: "OPEN",
              ...
              "effect-atom": JSON.stringify([
                {
                  number: 1618,
                  title: "Correct PR",
                  url: "https://github.com/dengor21/t3code/pull/1618",
                  baseRefName: "main",
              ...
              "upstream/effect-atom": JSON.stringify([
                {
                  number: 1518,
                  title: "Wrong PR",
                  url: "https://github.com/dengor21/t3code/pull/1518",
                  baseRefName: "main",
      ...
      const { manager } = yield* makeManager({
        ghScenario: {
          pullRequest: {
            ...
            url: "https://github.com/dengor21/t3code/pull/642",
            baseRefName: "main",
