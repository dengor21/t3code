...
const makeOpenCodeTextGeneration = Effect.gen(function* () {
  ...
  const generateChangeDocumentation: TextGenerationShape["generateChangeDocumentation"] = Effect.fn(
    "OpenCodeTextGeneration.generateChangeDocumentation",
  )(function* (input) {
    if (input.modelSelection.provider !== "opencode") {
      return yield* new TextGenerationError({
  ...
  const generateInitialDocumentation: TextGenerationShape["generateInitialDocumentation"] =
    Effect.fn("OpenCodeTextGeneration.generateInitialDocumentation")(function* (input) {
      if (input.modelSelection.provider !== "opencode") {
        return yield* new TextGenerationError({
  ...
  const generateHostDocumentation: TextGenerationShape["generateHostDocumentation"] = Effect.fn(
    "OpenCodeTextGeneration.generateHostDocumentation",
  )(function* (input) {
    if (input.modelSelection.provider !== "opencode") {
      return yield* new TextGenerationError({
