...
import Migration0026 from "./Migrations/026_ProjectionThreadsScopedHostName.ts";
import Migration0027 from "./Migrations/027_ProjectionThreadsChangeTracking.ts";
import Migration0028 from "./Migrations/028_HostDeployments.ts";
import Migration0029 from "./Migrations/029_FlakeMaintenance.ts";
import Migration0030 from "./Migrations/030_ProjectionThreadsWorkflow.ts";
...
import Migration0035 from "./Migrations/035_ProjectionThreadsDesigner.ts";
import Migration0036 from "./Migrations/036_BackfillProjectionThreadsHostDesigner.ts";
import Migration0037 from "./Migrations/037_ProjectionThreadsRemoteHostAccessPolicy.ts";
...
export const migrationEntries = [
  ...
  [26, "ProjectionThreadsScopedHostName", Migration0026],
  [27, "ProjectionThreadsChangeTracking", Migration0027],
  [28, "HostDeployments", Migration0028],
  [29, "FlakeMaintenance", Migration0029],
  [30, "ProjectionThreadsWorkflow", Migration0030],
  ...
  [35, "ProjectionThreadsDesigner", Migration0035],
  [36, "BackfillProjectionThreadsHostDesigner", Migration0036],
  [37, "ProjectionThreadsRemoteHostAccessPolicy", Migration0037],
] as const;
